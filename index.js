...
var Vec4 = geom.Vec4;
var Mat4 = geom.Mat4;
var DisplacedMatCap = require('./assets/materials/DisplacedMatCap');
var Fluid = require('./src/fluid/fluid');
var DrawForce = require('./src/fluid/DrawForce');
  ...
  setupGui: function () {
    ...
    this.on('keyDown', function(e) {
      ...
      switch(e.str) {
        ...
        case 'S': this.gui.save('./assets/client.gui.settings.txt'); break;
        case 'L': this.gui.load('./assets/client.gui.settings.txt'); break;
      }
    }.bind(this));

    this.gui.load('./assets/client.gui.settings.txt');
  },
